...
class SimioTables:
    ...
    def load_output_tables(self):
        ...
        for _table_name in self.output_file_list:
            ...
            experiment_dictionary[_table_name.split('.')[0]] = output_table.load_single_table(tag_name='StateValue', attribute_name='Name')
    ...
    def load_input_tables(self):
        ...
        for _table_name in self.input_file_list:
            ...
            input_table = InputTable(model_metadata=self.model_metadata,
                                       table_path=table_path)
            experiment_dictionary[_table_name.split('.')[0]] = input_table.load_single_table(tag_name='Property', attribute_name='Name')
...
if __name__ == '__main__':
    ...
    tables_ = SimioTables(path_to_project=project_path,
